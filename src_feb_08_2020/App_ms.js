...
function App() {
  return (
    <Router>
      <div>
        <Grid container spacing={2} border={3}>
          <Grid item xs={12}>
            <Header />
          </Grid>
          ...
          <Grid container item xs={8}>
            <Grid item xs={12}>
              <Switch>
                ...
                />
                <Route
                  path="/accountOnboarding/rmTagging"
                  exact
                  component={AccountOnboarding}
                />
                <Route
                  path="/accountOnboarding/kycWriteup"
                  exact
                  component={AccountOnboarding}
                />
                <Route
                  path="/accountOnboarding/riskAssessment"
                  exact
                  component={AccountOnboarding}
                />
                <Route
                  path="/accountOnboarding/documentUpload"
                  exact
                  component={AccountOnboarding}
                />
                <Route
                  path="/accountOnboarding/submit"
                  exact
                  component={AccountOnboarding}
                />
              </Switch>
